...
private String contact;
     ...
     * Creates new form R
     */
    public R(String contact,String password) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 340, 1440, 500));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(maxmin=="Min Price"){
            try {
                ...
                ResultSet rs = MyCon.retrieveData("SELECT p.* FROM vflat AS p WHERE p.flat_price = (SELECT MIN(flat_price) FROM vflat WHERE seller_contact = '" + contact + "');");
            ...
            try {
                ...
                ResultSet rs = MyCon.retrieveData("SELECT p.* FROM vflat AS p WHERE p.flat_price = (SELECT MAX(flat_price) FROM vflat WHERE seller_contact = '" + contact + "');");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            if ("Ascending".equals(sortPrice)) {
                rs1 = MyCon.retrieveData("SELECT * FROM vflat WHERE seller_contact = '" + contact + "' ORDER BY flat_price ASC;");
            } else if ("Descending".equals(sortPrice)) {
                rs1 = MyCon.retrieveData("SELECT * FROM vflat WHERE seller_contact = '" + contact + "' ORDER BY flat_price DESC;");
            }
            while (rs1.next()) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sqlQuery = "SELECT SUM(flat_price) AS total_price FROM vflat where seller_contact='" + contact + "'";
        ...
        if (total == "Total Price") {
            ...
            String sqlQuery1 = "SELECT AVG(flat_price) AS average FROM vflat where seller_contact='" + contact + "'";
            ...
            String sqlQuery2 = "SELECT COUNT(flat_price) AS count FROM vflat where seller_contact='" + contact + "'";
