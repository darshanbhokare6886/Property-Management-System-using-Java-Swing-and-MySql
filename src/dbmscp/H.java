...
public class H extends javax.swing.JFrame {
     ...
     * Creates new form H
     */
    public H(String contact, String password) {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Rent Availability");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 330, 260, 40));
        ...
        jLabel6.setText("Rent Duration");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 450, 240, 40));
        ...
        getContentPane().add(jComboBox4, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 340, 78, 30));
        ...
        jComboBox5.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2023", "2024" }));
        getContentPane().add(jComboBox5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 340, 120, 30));

        jComboBox6.setBackground(new java.awt.Color(255, 255, 255));
        jComboBox6.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        ...
        getContentPane().add(jComboBox6, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 340, 120, 30));
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "3 Months", "6 Months", "9 Months", "12 Months" }));
        getContentPane().add(jComboBox3, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 450, 230, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String locality = (String) jComboBox2.getSelectedItem();
        ...
        String insert = "INSERT INTO rent (seller_id,rent_price, rent_duration, rent_locality, rent_amenities,rent_availability,rent_city) VALUES ('"
                + sellerId + "', '" + price + "', '" + duration + "', '" + locality + "','" + ame + "','" + ava + "','" + location + "')";
