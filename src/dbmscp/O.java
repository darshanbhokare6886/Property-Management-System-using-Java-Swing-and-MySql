...
public class O extends javax.swing.JFrame {
    ...
    static String buyerId = null;

    /**
     * Creates new form O
     */
    public O(String contact, String password) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            String deleteQuery = "DELETE FROM buyer WHERE buy_id = " + buyerId;
            MyCon.deleteData(deleteQuery);

            JOptionPane.showMessageDialog(null, "Buyer data deleted successfully.");
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
    // First, fetch the buyerId based on the contact and password
    String query = "SELECT buy_id FROM buyer WHERE buy_contact = '" + contact + "' AND buy_password = '" + password + "'";
    ResultSet resultSet = MyCon.retrieveData(query);

    if (resultSet.next()) {
        buyerId = resultSet.getString("buy_id");
    }
    resultSet.close();

    if (buyerId != null) {
        // Now fetch data corresponding to the buyerId
        String fetchDataQuery = "SELECT buy_name, buy_contact, buy_mail, buy_address, buy_password FROM buyer WHERE buy_id = " + buyerId;
        ...
        if (dataResultSet.next()) {
            ...
            jTextField2.setText(dataResultSet.getString("buy_name"));
            jTextField3.setText(dataResultSet.getString("buy_contact"));
            jTextField4.setText(dataResultSet.getString("buy_mail"));
            jTextField5.setText(dataResultSet.getString("buy_address"));
            jTextField6.setText(dataResultSet.getString("buy_password"));
        }

        dataResultSet.close();
    } else {
        JOptionPane.showMessageDialog(null, "Buyer with this contact number and password does not exist.");
    }
} catch (Exception e) {
    e.printStackTrace();
}
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String updateQuery = "UPDATE buyer SET buy_name = '" + name + "', buy_mail = '" + email + "', buy_address = '" + address + "',buy_contact = '" + contactNo + "',buy_password = '" + pass + "' WHERE buy_id = " + buyerId;
        MyCon.updateData(updateQuery);

        JOptionPane.showMessageDialog(null, "Buyer data updated successfully.");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        setVisible(false);
        new J(contact,password).setVisible(true);
