...
public class I extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("BUYER LOGIN");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 120, 670, 100));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Contact No");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 400, 210, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String query = "SELECT * FROM buyer WHERE buy_contact = '" + contact + "' AND buy_password = '" + password + "'";
            ...
            if (resultSet.next()) {
                ...
                new J(contact,password).setVisible(true); // Open the next window (replace 'D' with the correct window name)
            } else {
